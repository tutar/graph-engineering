...
const DEFINITION = "github-pr-review/v0.1.3";
const PROFILE = "github-pr-review/codex/v0.1.3";
...
function validateProfile(profile) {
  ...
  if (profile.executor?.id !== "codex-compatible-executor" || profile.executor?.version !== "v0.1.3") throw new Error("Profile executor does not match the bundled Executor");
