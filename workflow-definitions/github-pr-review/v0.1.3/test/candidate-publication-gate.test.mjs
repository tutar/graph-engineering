...
const release = read("../../../../docs/releases/v0.2.3.md");
...
test("v0.2.3 distinguishes repository and Definition versions without overstating evidence", () => {
  assert.match(release, /Repository Release:\s*`v0\.2\.3`/);
  assert.match(release, /Workflow Definition:\s*`github-pr-review\/v0\.1\.3`/);
  ...
  assert.match(rootReadme, /github-pr-review.*v0\.1\.3.*Candidate/is);
