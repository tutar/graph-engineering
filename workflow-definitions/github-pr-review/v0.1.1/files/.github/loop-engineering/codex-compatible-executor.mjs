...
const DEFINITION = "github-pr-review/v0.1.1";
const PROFILE = "github-pr-review/codex/v0.1.1";
...
function validateProfile(profile) {
  ...
  if (profile.executor?.id !== "codex-compatible-executor" || profile.executor?.version !== "v0.1.1") throw new Error("Profile executor does not match the bundled Executor");
  ...
  assertExactKeys(profile.action, ["source", "sourceTag", "commit", "codexVersion", "requiredInputs", "acceptedInputs"], "Profile Action");
  ...
  assertJsonEqual(profile.action.requiredInputs, ["prompt-file", "output-schema-file", "working-directory", "codex-version", "permission-profile", "safety-strategy"], "required inputs");
