...
const release = read("../../../../docs/releases/v0.2.1.md");
...
test("v0.2.1 distinguishes repository and Definition versions without overstating evidence", () => {
  assert.match(release, /Repository Release:\s*`v0\.2\.1`/);
  assert.match(release, /Workflow Definition:\s*`github-pr-review\/v0\.1\.1`/);
  ...
  assert.match(rootReadme, /github-pr-review.*v0\.1\.1.*Candidate/is);
