...
状态：本地准备，尚未公开发布。该版本针对 [Bundle 5 的 HTTP 400 schema 拒绝](https://github.com/tutar/loop-engineering/issues/29#issuecomment-5696742062) 修复 Action 输出契约，保留已发布 `v0.1.3` 不变。
