...
const release = read("../../../../docs/releases/v0.2.5.md");
...
test("v0.2.5 distinguishes repository and Definition versions without overstating evidence", () => {
  assert.match(release, /Repository Release:\s*`v0\.2\.5`/);
  assert.match(release, /Workflow Definition:\s*`github-pr-review\/v0\.1\.5`/);
  ...
  assert.match(rootReadme, /github-pr-review.*v0\.1\.5.*Candidate/is);
