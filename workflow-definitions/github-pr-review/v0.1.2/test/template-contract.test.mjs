...
test("the Profile declares the immutable mapping and every validation boundary", () => {
  assert.equal(profile.definition, "github-pr-review/v0.1.2");
  assert.equal(profile.executor.id, "codex-compatible-executor");
  assert.equal(profile.executor.version, "v0.1.2");
  assert.deepEqual(profile.action.requiredInputs, ["prompt-file", "output-schema-file", "working-directory", "codex-version", "permission-profile", "safety-strategy"]);
